...
class PostMemberUpdatedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostMemberUpdatedPayloadApiVersion = pydantic.Field()
    """
    ...
    type: PostMemberUpdatedPayloadType = pydantic.Field()
    """
