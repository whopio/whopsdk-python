...
from .post_ledger_account_funds_available_payload_api_version import PostLedgerAccountFundsAvailablePayloadApiVersion
from .post_ledger_account_funds_available_payload_type import PostLedgerAccountFundsAvailablePayloadType


class PostLedgerAccountFundsAvailablePayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostLedgerAccountFundsAvailablePayloadApiVersion = pydantic.Field()
    """
    ...
    type: PostLedgerAccountFundsAvailablePayloadType = pydantic.Field()
    """
