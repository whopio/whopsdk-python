...
class PostDisputeUpdatedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostDisputeUpdatedPayloadApiVersion = pydantic.Field()
    """
    ...
    type: PostDisputeUpdatedPayloadType = pydantic.Field()
    """
