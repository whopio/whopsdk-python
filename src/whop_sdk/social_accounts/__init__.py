...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "ConnectSocialAccountsRequestScopesItem": ".types",
    "ConnectSocialAccountsResponse": ".types",
    "CreateSocialAccountsRequestPlatform": ".types",
    "DeleteSocialAccountsResponse": ".types",
    "LeadFormsSocialAccountsResponse": ".types",
    "ListSocialAccountsRequestDirection": ".types",
