...
class PostPaymentPendingPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostPaymentPendingPayloadApiVersion = pydantic.Field()
    """
    ...
    type: PostPaymentPendingPayloadType = pydantic.Field()
    """
