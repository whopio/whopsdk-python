...
from .post_pixel_event_created_payload_data_context_source_type import PostPixelEventCreatedPayloadDataContextSourceType


class PostPixelEventCreatedPayloadDataContext(UniversalBaseModel):
    ...
    source_type: typing.Optional[PostPixelEventCreatedPayloadDataContextSourceType] = pydantic.Field(default=None)
    """
