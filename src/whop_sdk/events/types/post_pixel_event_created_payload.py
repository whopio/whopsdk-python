...
class PostPixelEventCreatedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostPixelEventCreatedPayloadApiVersion = pydantic.Field()
    """
    ...
    data: PostPixelEventCreatedPayloadData
    ...
    type: PostPixelEventCreatedPayloadType = pydantic.Field()
    """
