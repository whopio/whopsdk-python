...
class DisputeAlertLegacy(UniversalBaseModel):
    """
    ...
    dispute: typing.Optional[DisputeAlertLegacyDispute] = pydantic.Field(default=None)
    """
    ...
    payment: typing.Optional[DisputeAlertLegacyPayment] = pydantic.Field(default=None)
    """
