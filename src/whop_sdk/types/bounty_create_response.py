...
__all__ = [
    ...
    "ActiveProofLivestreamFeed",
    "ActiveProofLivestreamFeedHost",
    "ActiveProofLivestreamFeedHostProfilePicture",
    "CaptureSpec",
    "CaptureSpecImu",
    "CaptureSpecVideo",
    "FundingAccount",
...
class ActiveProofLivestreamFeedHostProfilePicture(BaseModel):
    """
...
class ActiveProofLivestreamFeedHost(BaseModel):
    """User hosting the proof livestream — the worker streaming their attempt.

    `null` if the host account no longer exists.
    """
    ...
    profile_picture: ActiveProofLivestreamFeedHostProfilePicture
    """
...
class ActiveProofLivestreamFeed(BaseModel):
    """
    ...
    host: Optional[ActiveProofLivestreamFeedHost] = None
    """User hosting the proof livestream — the worker streaming their attempt.
...
class BountyCreateResponse(BaseModel):
    ...
    active_proof_livestream_feeds: List[ActiveProofLivestreamFeed]
    ...
    awaiting_review_submissions_count: int
    """Submissions delivered and waiting on review.

    A subset of `unresolved_submissions_count`, which also counts attempts still in
    progress.
    """
    ...
    min_total_verified_duration_seconds: Optional[int] = None
    """
