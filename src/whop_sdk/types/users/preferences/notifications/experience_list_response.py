...
__all__ = ["ExperienceListResponse", "Scope"]
...
class ExperienceListResponse(BaseModel):
    level: Literal["all", "mentions", "nothing"]
    """
    What the user is notified about in the experience: `all` notifications, only
    `mentions`, or `nothing`.
    """

    object: Literal["experience_notification_preference"]
