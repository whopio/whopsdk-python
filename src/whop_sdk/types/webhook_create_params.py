...
class WebhookCreateParams(TypedDict, total=False):
    ...
    body_api_version_date: Annotated[Optional[str], PropertyInfo(alias="api_version_date")]
    ...
    header_api_version_date: Annotated[str, PropertyInfo(alias="Api-Version-Date")]
