...
class BountyListItem(UniversalBaseModel):
    accepted_deliverable_types: typing.List[BountyListItemAcceptedDeliverableTypesItem]
    ...
    business_goal_type: typing.Optional[BountyListItemBusinessGoalType] = pydantic.Field(default=None)
    """
    ...
    scheduled_frequency: typing.Optional[BountyListItemScheduledFrequency] = pydantic.Field(default=None)
    """
    ...
    status: BountyListItemStatus = pydantic.Field()
    """
