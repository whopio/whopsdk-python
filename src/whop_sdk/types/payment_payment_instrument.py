...
class PaymentPaymentInstrument(UniversalBaseModel):
    """
    ...
    card: typing.Optional[PaymentPaymentInstrumentCard] = pydantic.Field(default=None)
    """
    ...
    icons: PaymentPaymentInstrumentIcons = pydantic.Field()
    """
