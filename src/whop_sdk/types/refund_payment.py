...
class RefundPayment(UniversalBaseModel):
    """
    ...
    member: typing.Optional[RefundPaymentMember] = pydantic.Field(default=None)
    """
    The member attached to this payment.
    """

    membership: typing.Optional[RefundPaymentMembership] = pydantic.Field(default=None)
    """
    ...
    plan: typing.Optional[RefundPaymentPlan] = pydantic.Field(default=None)
    """
    The plan attached to this payment.
    """

    product: typing.Optional[RefundPaymentProduct] = pydantic.Field(default=None)
    """
    ...
    user: typing.Optional[RefundPaymentUser] = pydantic.Field(default=None)
    """
