...
class DataSource(BaseModel):
    ...
    """Withdrawal creation time as a Unix timestamp (withdrawal sources only)."""

    estimated_arrival: Optional[int] = None
    """Estimated arrival as a Unix timestamp (withdrawal sources only)."""

    payer_name: Optional[str] = None
    """Name of the entity processing the payout (withdrawal sources only)."""
    ...
    """Withdrawal lifecycle status (withdrawal sources only)."""
