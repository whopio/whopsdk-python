...
__all__ = [
    ...
    "Data",
    "DataCancellationPolicyAttachment",
    "DataCompany",
    "DataCustomerCommunicationAttachment",
    "DataPayment",
    "DataPaymentMember",
    ...
    "DataPlan",
    "DataProduct",
    "DataRefundPolicyAttachment",
    "DataUncategorizedAttachment",
]


class DataCancellationPolicyAttachment(BaseModel):
    id: str
...
class DataCustomerCommunicationAttachment(BaseModel):
    id: str
    """The ID of the attachment"""
...
class DataRefundPolicyAttachment(BaseModel):
    id: str
    """The ID of the attachment"""
...
class DataUncategorizedAttachment(BaseModel):
    id: str
    """The ID of the attachment"""
...
class Data(BaseModel):
    ...
    cancellation_policy_attachment: Optional[DataCancellationPolicyAttachment] = None
    ...
    customer_communication_attachment: Optional[DataCustomerCommunicationAttachment] = None
    ...
    refund_policy_attachment: Optional[DataRefundPolicyAttachment] = None
    ...
    uncategorized_attachment: Optional[DataUncategorizedAttachment] = None
...
class DisputeCreatedWebhookEvent(BaseModel):
    id: str
