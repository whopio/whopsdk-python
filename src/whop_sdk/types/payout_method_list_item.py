...
class PayoutMethodListItem(UniversalBaseModel):
    """
    ...
    company: typing.Optional[PayoutMethodListItemCompany] = pydantic.Field(default=None)
    """
    ...
    destination: typing.Optional[PayoutMethodListItemDestination] = pydantic.Field(default=None)
    """
