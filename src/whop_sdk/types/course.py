...
class Course(UniversalBaseModel):
    """
    ...
    chapters: typing.List[CourseChaptersItem] = pydantic.Field()
    """
    ...
    resume_lesson: typing.Optional[CourseResumeLesson] = pydantic.Field(default=None)
    """
    ...
    thumbnail: typing.Optional[CourseThumbnail] = pydantic.Field(default=None)
    """
