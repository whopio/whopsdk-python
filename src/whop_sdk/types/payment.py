...
class Payment(UniversalBaseModel):
    ...
    application_fee: typing.Optional[PaymentApplicationFee] = pydantic.Field(default=None)
    """
    ...
    billing_address: typing.Optional[PaymentBillingAddress] = pydantic.Field(default=None)
    """
    ...
    disputes: typing.Optional[typing.List[PaymentDisputesItem]] = pydantic.Field(default=None)
    """
    ...
    financing_transactions: typing.List[PaymentFinancingTransactionsItem] = pydantic.Field()
    """
    ...
    member: typing.Optional[PaymentMember] = pydantic.Field(default=None)
    """
    The member attached to this payment.
    """

    membership: typing.Optional[PaymentMembership] = pydantic.Field(default=None)
    """
    ...
    payment_instrument: typing.Optional[PaymentPaymentInstrument] = pydantic.Field(default=None)
    """
    ...
    plan: typing.Optional[PaymentPlan] = pydantic.Field(default=None)
    """
    The plan attached to this payment.
    """

    product: typing.Optional[PaymentProduct] = pydantic.Field(default=None)
    """
    The product this payment was made for
    """

    promo_code: typing.Optional[PaymentPromoCode] = pydantic.Field(default=None)
    """
    ...
    refunds: typing.List[PaymentRefundsItem] = pydantic.Field()
    """
    ...
    resolutions: typing.Optional[typing.List[PaymentResolutionsItem]] = pydantic.Field(default=None)
    """
    ...
    shipment: typing.Optional[PaymentShipment] = pydantic.Field(default=None)
    """
    The shipment attached to this payment.
    """

    shipping_address: typing.Optional[PaymentShippingAddress] = pydantic.Field(default=None)
    """
    ...
    user: typing.Optional[PaymentUser] = pydantic.Field(default=None)
    """
