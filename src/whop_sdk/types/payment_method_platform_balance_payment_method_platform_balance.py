...
class PaymentMethodPlatformBalancePaymentMethodPlatformBalance(UniversalBaseModel):
    """
    What is available to spend, and whether the account may spend it.
    """

    account: typing.Optional[PaymentMethodPlatformBalancePaymentMethodPlatformBalanceAccount] = pydantic.Field(
        default=None
    )
    """
    ...
    balances: typing.List[PaymentMethodPlatformBalancePaymentMethodPlatformBalanceBalancesItem] = pydantic.Field()
    """
