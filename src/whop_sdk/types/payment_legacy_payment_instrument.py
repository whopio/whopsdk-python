...
class PaymentLegacyPaymentInstrument(UniversalBaseModel):
    """
    ...
    card: typing.Optional[PaymentLegacyPaymentInstrumentCard] = pydantic.Field(default=None)
    """
    ...
    icons: PaymentLegacyPaymentInstrumentIcons = pydantic.Field()
    """
