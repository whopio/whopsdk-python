...
class PaymentPaymentInstrumentIcons(UniversalBaseModel):
    """
    The standard icon set: square and card shapes, each in light and dark colorways.
    """

    card: PaymentPaymentInstrumentIconsCard = pydantic.Field()
    """
    The credit-card-proportioned tile (48x30).
    """

    square: PaymentPaymentInstrumentIconsSquare = pydantic.Field()
    """
