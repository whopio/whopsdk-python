...
class PaymentMethodListItemCashappPaymentMethod(UniversalBaseModel):
    """
    A saved Cash App payment method, including the buyer's cashtag and unique identifier.
    """

    cashapp: PaymentMethodListItemCashappPaymentMethodCashapp = pydantic.Field()
    """
    ...
    icons: PaymentMethodListItemCashappPaymentMethodIcons = pydantic.Field()
    """
