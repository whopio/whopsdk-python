...
class PaymentMethodListItemUsBankAccountPaymentMethod(UniversalBaseModel):
    """
    ...
    icons: PaymentMethodListItemUsBankAccountPaymentMethodIcons = pydantic.Field()
    """
    ...
    us_bank_account: PaymentMethodListItemUsBankAccountPaymentMethodUsBankAccount = pydantic.Field()
    """
