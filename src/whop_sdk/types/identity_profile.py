...
class IdentityProfile(UniversalBaseModel):
    """
    A consolidated identity or business profile synced from verification provider data.
    """

    business_address: typing.Optional[IdentityProfileBusinessAddress] = pydantic.Field(default=None)
    """
    ...
    linked_companies: typing.List[IdentityProfileLinkedCompaniesItem] = pydantic.Field()
    """
    ...
    personal_address: typing.Optional[IdentityProfilePersonalAddress] = pydantic.Field(default=None)
    """
    ...
    verifications: typing.List[IdentityProfileVerificationsItem] = pydantic.Field()
    """
