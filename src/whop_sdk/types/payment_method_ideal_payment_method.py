...
class PaymentMethodIdealPaymentMethod(UniversalBaseModel):
    """
    ...
    icons: PaymentMethodIdealPaymentMethodIcons = pydantic.Field()
    """
    ...
    ideal: PaymentMethodIdealPaymentMethodIdeal = pydantic.Field()
    """
