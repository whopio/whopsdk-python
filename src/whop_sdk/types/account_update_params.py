...
class AccountUpdateParams(TypedDict, total=False):
    ...
    """Determines whether Whop or the account calculates and remits tax.

    The account must provide a supported-country business address when it
    self-remits.
    """
...
class StorePageConfig(TypedDict, total=False):
    ...
    layout: Optional[Literal["featured", "compact"]]
    """Layout used on the account store page."""

    profile_variant: Optional[Literal["personal", "business"]]
