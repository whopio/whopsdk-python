...
class CompanyTokenTransaction(UniversalBaseModel):
    """
    ...
    company: CompanyTokenTransactionCompany = pydantic.Field()
    """
    ...
    member: CompanyTokenTransactionMember = pydantic.Field()
    """
    ...
    user: CompanyTokenTransactionUser = pydantic.Field()
    """
