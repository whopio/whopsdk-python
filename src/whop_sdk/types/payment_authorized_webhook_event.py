...
__all__ = [
    ...
    "DataDispute",
    "DataFee",
    "DataFinancingTransaction",
    "DataMember",
    "DataMembership",
    "DataPaymentInstrument",
    "DataPaymentInstrumentCard",
    "DataPaymentInstrumentIcons",
    "DataPaymentInstrumentIconsCard",
    "DataPaymentInstrumentIconsCardDark",
    "DataPaymentInstrumentIconsCardLight",
    "DataPaymentInstrumentIconsSquare",
    "DataPaymentInstrumentIconsSquareDark",
    "DataPaymentInstrumentIconsSquareLight",
    "DataPaymentMethod",
    "DataPaymentMethodCard",
    "DataPlan",
    "DataProduct",
    "DataPromoCode",
    "DataRefund",
    ...
    "DataShippingAddress",
    "DataUser",
    "DataVerificationChecks",
]


class DataApplicationFee(BaseModel):
...
class DataFinancingTransaction(BaseModel):
...
class DataPaymentInstrumentCard(BaseModel):
...
class DataPaymentInstrumentIconsCardDark(BaseModel):
...
class DataPaymentInstrumentIconsCardLight(BaseModel):
...
class DataPaymentInstrumentIconsCard(BaseModel):
    """The credit-card-proportioned tile (48x30)."""

    dark: DataPaymentInstrumentIconsCardDark
    """The colorway for dark surfaces."""

    light: DataPaymentInstrumentIconsCardLight
    """The colorway for light surfaces."""


class DataPaymentInstrumentIconsSquareDark(BaseModel):
    """The colorway for dark surfaces."""
...
class DataPaymentInstrumentIconsSquareLight(BaseModel):
    """The colorway for light surfaces."""
...
class DataPaymentInstrumentIconsSquare(BaseModel):
    """The square tile (32x32)."""

    dark: DataPaymentInstrumentIconsSquareDark
    """The colorway for dark surfaces."""

    light: DataPaymentInstrumentIconsSquareLight
    """The colorway for light surfaces."""


class DataPaymentInstrumentIcons(BaseModel):
    """
    The standard icon set: square and card shapes, each in light and dark colorways.
    """

    card: DataPaymentInstrumentIconsCard
    """The credit-card-proportioned tile (48x30)."""

    square: DataPaymentInstrumentIconsSquare
    """The square tile (32x32)."""


class DataPaymentInstrument(BaseModel):
    """
    ...
    card: Optional[DataPaymentInstrumentCard] = None
    """Card payments only: the card's network and last four."""
    ...
    icons: DataPaymentInstrumentIcons
    """
    The standard icon set: square and card shapes, each in light and dark colorways.
    """
...
class DataPaymentMethodCard(BaseModel):
    """
...
class DataPaymentMethod(BaseModel):
    ...
    card: Optional[DataPaymentMethodCard] = None
    """
    The card data associated with the payment method, if its a debit or credit card.
    """
...
class DataShippingAddress(BaseModel):
...
class DataVerificationChecks(BaseModel):
...
class Data(BaseModel):
    ...
    application_fee: Optional[DataApplicationFee] = None
    """The application fee charged on this payment."""
    ...
    disputes: Optional[List[DataDispute]] = None
    ...
    financing_transactions: List[DataFinancingTransaction]
    ...
    membership: Optional[DataMembership] = None
    """The membership attached to this payment."""
    ...
    payment_instrument: Optional[DataPaymentInstrument] = None
    """
    ...
    payment_method: Optional[DataPaymentMethod] = None
    """The tokenized payment method reference used for this payment.
    ...
    plan: Optional[DataPlan] = None
    """The plan attached to this payment."""

    product: Optional[DataProduct] = None
    """The product this payment was made for"""

    promo_code: Optional[DataPromoCode] = None
    """The promo code used for this payment."""
    ...
    resolutions: Optional[List[DataResolution]] = None
    ...
    shipment: Optional[DataShipment] = None
    """The shipment attached to this payment."""

    shipping_address: Optional[DataShippingAddress] = None
    """The shipping address provided by the customer for physical goods.
    ...
    verification_checks: Optional[DataVerificationChecks] = None
    """The issuer's address and card security code check results for this payment.
...
class PaymentAuthorizedWebhookEvent(BaseModel):
    id: str
    ...
    type: Literal["payment.authorized"]
