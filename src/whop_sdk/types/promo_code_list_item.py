...
class PromoCodeListItem(UniversalBaseModel):
    ...
    currency: PromoCodeListItemCurrency = pydantic.Field()
    """
    Currency used for a fixed-amount discount.
    """

    duration: PromoCodeListItemDuration = pydantic.Field()
    """
    ...
    promo_type: PromoCodeListItemPromoType = pydantic.Field()
    """
    Whether the discount is percentage-based or a fixed amount.
    """

    status: PromoCodeListItemStatus = pydantic.Field()
    """
