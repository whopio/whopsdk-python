...
class DataSecrets(BaseModel):
    ...
    Only present when reveal_secrets=true; null for cards that are not active or whose details could not be retrieved.
    """
...
class Data(BaseModel):
    ...
    Only present when reveal_secrets=true; null for cards that are not active or
    whose details could not be retrieved.
    """
