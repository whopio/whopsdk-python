...
class PaymentMethodListItemPlatformBalancePaymentMethodIconsSquare(UniversalBaseModel):
    """
    The square tile (32x32).
    """

    dark: PaymentMethodListItemPlatformBalancePaymentMethodIconsSquareDark = pydantic.Field()
    """
    The colorway for dark surfaces.
    """

    light: PaymentMethodListItemPlatformBalancePaymentMethodIconsSquareLight = pydantic.Field()
    """
