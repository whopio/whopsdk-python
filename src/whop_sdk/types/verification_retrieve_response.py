...
__all__ = [
    ...
    "RequestedInformationSupportingDocument",
    "RequestedInformationSupportingDocumentMultipartUploadURL",
    "RequiredDocument",
]
...
class RequestedInformationSupportingDocumentMultipartUploadURL(BaseModel):
...
class RequestedInformationSupportingDocument(BaseModel):
    id: str
    ...
    multipart_upload_urls: Optional[List[RequestedInformationSupportingDocumentMultipartUploadURL]] = None
...
class RequestedInformation(BaseModel):
    ...
    supporting_documents: Optional[List[RequestedInformationSupportingDocument]] = None
