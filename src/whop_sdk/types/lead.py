...
class Lead(UniversalBaseModel):
    ...
    member: typing.Optional[LeadMember] = pydantic.Field(default=None)
    """
    ...
    product: typing.Optional[LeadProduct] = pydantic.Field(default=None)
    """
