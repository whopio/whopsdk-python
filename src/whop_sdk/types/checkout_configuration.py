...
class CheckoutConfiguration(UniversalBaseModel):
    ...
    currency: typing.Optional[CheckoutConfigurationCurrency] = pydantic.Field(default=None)
    """
    ...
    mode: CheckoutConfigurationMode = pydantic.Field()
    """
    ...
    plan: typing.Optional[CheckoutConfigurationPlan] = pydantic.Field(default=None)
    """
    ...
    three_ds_level: typing.Optional[CheckoutConfigurationThreeDsLevel] = pydantic.Field(default=None)
    """
