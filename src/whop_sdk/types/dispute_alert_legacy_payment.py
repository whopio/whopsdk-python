...
class DisputeAlertLegacyPayment(UniversalBaseModel):
    """
    ...
    member: typing.Optional[DisputeAlertLegacyPaymentMember] = pydantic.Field(default=None)
    """
    The member attached to this payment.
    """

    membership: typing.Optional[DisputeAlertLegacyPaymentMembership] = pydantic.Field(default=None)
    """
    ...
    user: typing.Optional[DisputeAlertLegacyPaymentUser] = pydantic.Field(default=None)
    """
