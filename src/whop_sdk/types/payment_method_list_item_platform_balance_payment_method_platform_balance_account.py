...
class PaymentMethodListItemPlatformBalancePaymentMethodPlatformBalanceAccount(UniversalBaseModel):
    """
    ...
    logo: typing.Optional[PaymentMethodListItemPlatformBalancePaymentMethodPlatformBalanceAccountLogo] = pydantic.Field(
        default=None
    )
    """
    The company's logo.
