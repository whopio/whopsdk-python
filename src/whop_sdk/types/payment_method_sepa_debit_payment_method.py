...
class PaymentMethodSepaDebitPaymentMethod(UniversalBaseModel):
    """
    ...
    icons: PaymentMethodSepaDebitPaymentMethodIcons = pydantic.Field()
    """
    ...
    sepa_debit: PaymentMethodSepaDebitPaymentMethodSepaDebit = pydantic.Field()
    """
