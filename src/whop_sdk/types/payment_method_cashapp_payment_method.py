...
class PaymentMethodCashappPaymentMethod(UniversalBaseModel):
    """
    A saved Cash App payment method, including the buyer's cashtag and unique identifier.
    """

    cashapp: PaymentMethodCashappPaymentMethodCashapp = pydantic.Field()
    """
    ...
    icons: PaymentMethodCashappPaymentMethodIcons = pydantic.Field()
    """
