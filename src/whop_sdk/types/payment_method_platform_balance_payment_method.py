...
class PaymentMethodPlatformBalancePaymentMethod(UniversalBaseModel):
    """
    ...
    icons: PaymentMethodPlatformBalancePaymentMethodIcons = pydantic.Field()
    """
    ...
    platform_balance: PaymentMethodPlatformBalancePaymentMethodPlatformBalance = pydantic.Field()
    """
