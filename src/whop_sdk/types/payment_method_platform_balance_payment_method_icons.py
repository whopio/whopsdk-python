...
class PaymentMethodPlatformBalancePaymentMethodIcons(UniversalBaseModel):
    """
    ...
    card: PaymentMethodPlatformBalancePaymentMethodIconsCard = pydantic.Field()
    """
    The credit-card-proportioned tile (48x30).
    """

    square: PaymentMethodPlatformBalancePaymentMethodIconsSquare = pydantic.Field()
    """
