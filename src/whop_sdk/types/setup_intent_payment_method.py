...
class SetupIntentPaymentMethod(UniversalBaseModel):
    """
    The saved payment method created by this setup intent. Null if the setup has not completed successfully.
    """

    card: typing.Optional[SetupIntentPaymentMethodCard] = pydantic.Field(default=None)
    """
    ...
    mailing_address: typing.Optional[SetupIntentPaymentMethodMailingAddress] = pydantic.Field(default=None)
    """
