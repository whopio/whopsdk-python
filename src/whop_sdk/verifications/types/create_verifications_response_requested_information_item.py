...
class CreateVerificationsResponseRequestedInformationItem(UniversalBaseModel):
    ...
    errors: typing.Optional[typing.List[CreateVerificationsResponseRequestedInformationItemErrorsItem]] = (
    ...
    response_type: typing.Optional[CreateVerificationsResponseRequestedInformationItemResponseType] = pydantic.Field(
        default=None
    )
    """
    ...
    selection_mode: typing.Optional[CreateVerificationsResponseRequestedInformationItemSelectionMode] = pydantic.Field(
        default=None
    )
    """
