...
class RetrieveVerificationsResponseRequiredDocumentsItem(UniversalBaseModel):
    ...
    status: typing.Optional[RetrieveVerificationsResponseRequiredDocumentsItemStatus] = pydantic.Field(default=None)
    """
