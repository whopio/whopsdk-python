...
class UpdateVerificationsRequestBodyPersonalAddressRequestedInformationItem(UniversalBaseModel):
    address: typing.Optional[UpdateVerificationsRequestBodyPersonalAddressRequestedInformationItemAddress] = (
