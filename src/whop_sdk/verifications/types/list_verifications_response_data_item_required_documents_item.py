...
class ListVerificationsResponseDataItemRequiredDocumentsItem(UniversalBaseModel):
    ...
    status: typing.Optional[ListVerificationsResponseDataItemRequiredDocumentsItemStatus] = pydantic.Field(default=None)
    """
