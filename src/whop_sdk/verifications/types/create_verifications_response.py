...
class CreateVerificationsResponse(UniversalBaseModel):
    address: typing.Optional[CreateVerificationsResponseAddress] = pydantic.Field(default=None)
    """
    ...
    kind: typing.Optional[CreateVerificationsResponseKind] = None
    ...
    requested_information: typing.Optional[typing.List[CreateVerificationsResponseRequestedInformationItem]] = (
    ...
    required_documents: typing.Optional[typing.List[CreateVerificationsResponseRequiredDocumentsItem]] = pydantic.Field(
        default=None
    )
    """
    ...
    status: typing.Optional[CreateVerificationsResponseStatus] = pydantic.Field(default=None)
    """
