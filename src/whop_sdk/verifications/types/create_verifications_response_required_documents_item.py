...
class CreateVerificationsResponseRequiredDocumentsItem(UniversalBaseModel):
    ...
    status: typing.Optional[CreateVerificationsResponseRequiredDocumentsItemStatus] = pydantic.Field(default=None)
    """
