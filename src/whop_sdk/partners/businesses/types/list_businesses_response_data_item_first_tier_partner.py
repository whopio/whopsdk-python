...
class ListBusinessesResponseDataItemFirstTierPartner(UniversalBaseModel):
    """
    ...
    profile_picture: ListBusinessesResponseDataItemFirstTierPartnerProfilePicture = pydantic.Field()
    """
