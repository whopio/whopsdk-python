...
class LeaderboardPartnersResponseMeUser(UniversalBaseModel):
    """
    ...
    profile_picture: typing.Optional[LeaderboardPartnersResponseMeUserProfilePicture] = pydantic.Field(default=None)
    """
