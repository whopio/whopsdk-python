...
class PostEntryDeletedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostEntryDeletedPayloadApiVersion = pydantic.Field()
    """
    ...
    type: PostEntryDeletedPayloadType = pydantic.Field()
    """
