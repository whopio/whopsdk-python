...
class PostEntryApprovedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostEntryApprovedPayloadApiVersion = pydantic.Field()
    """
    ...
    type: PostEntryApprovedPayloadType = pydantic.Field()
    """
