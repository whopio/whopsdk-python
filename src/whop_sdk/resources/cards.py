...
from ..types import (
    ...
    card_create_dispute_params,
    card_card_transactions_params,
    card_create_dispute_attachment_params,
)
...
from ..types.card_pin import CardPin
from ..types.card_dispute import CardDispute
from ..types.card_secrets import CardSecrets
...
from ..types.card_update_pin_response import CardUpdatePinResponse
...
class CardsResource(SyncAPIResource):
    ...
    def create_dispute(
        ...
        *,
        ...
        text_evidence: str,
        transaction_id: str,
        dispute_amount_cents: int | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        """Files a dispute against one of the card's transactions.

        The transaction must
        belong to the addressed card.

        Args:
          dispute_type: The reason category for the dispute.

          text_evidence: The cardholder's written evidence for the dispute.

          transaction_id: The ID of the card transaction being disputed. Must belong to this card.

          dispute_amount_cents: Optional disputed amount in cents. Defaults to the full transaction amount. Must
        ...
        if not id:
            raise ValueError(f"Expected a non-empty value for `id` but received {id!r}")
        return self._post(
            path_template("/cards/{id}/disputes", id=id),
            body=maybe_transform(
                {
                ...
                card_create_dispute_params.CardCreateDisputeParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def create_dispute_attachment(
        ...
        *,
        id: str,
        attachment: card_create_dispute_attachment_params.Attachment,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        """Attaches an evidence file to a dispute on the card.
        ...
        return self._post(
            path_template("/cards/{id}/disputes/{dispute_id}/attachments", id=id, dispute_id=dispute_id),
            body=maybe_transform(
                {"attachment": attachment}, card_create_dispute_attachment_params.CardCreateDisputeAttachmentParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def pin(
        ...
        *,
        ...
        """Reveals the card PIN.

        Only the user the card is assigned to may read it. The
        ...
        if not id:
            raise ValueError(f"Expected a non-empty value for `id` but received {id!r}")
        return self._get(
            path_template("/cards/{id}/pin", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=CardPin,
    ...
    def secrets(
        ...
        *,
        ...
        """Reveals the full card number (PAN) and CVC.

        POST so the reveal is never cached.
        ...
        if not id:
            raise ValueError(f"Expected a non-empty value for `id` but received {id!r}")
        return self._post(
            path_template("/cards/{id}/secrets", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=CardSecrets,
    ...
    def update_pin(
        ...
        *,
        ...
        Only the user the card is assigned to may set it. The
        PIN is never echoed back.

        Args:
          pin: The new 4-digit PIN.
...
class AsyncCardsResource(AsyncAPIResource):
    ...
    async def create_dispute_attachment(
        self,
        dispute_id: str,
        *,
        id: str,
...
class CardsResourceWithRawResponse:
    def __init__(self, cards: CardsResource) -> None:
        ...
        self.create_dispute = to_raw_response_wrapper(
            cards.create_dispute,
        )
        self.create_dispute_attachment = to_raw_response_wrapper(
            cards.create_dispute_attachment,
        )
...
class AsyncCardsResourceWithRawResponse:
    def __init__(self, cards: AsyncCardsResource) -> None:
        ...
        self.create_dispute_attachment = async_to_raw_response_wrapper(
            cards.create_dispute_attachment,
        )
...
class CardsResourceWithStreamingResponse:
    def __init__(self, cards: CardsResource) -> None:
        ...
        self.create_dispute_attachment = to_streamed_response_wrapper(
            cards.create_dispute_attachment,
        )
...
class AsyncCardsResourceWithStreamingResponse:
    def __init__(self, cards: AsyncCardsResource) -> None:
        ...
        self.create_dispute_attachment = async_to_streamed_response_wrapper(
            cards.create_dispute_attachment,
        )
