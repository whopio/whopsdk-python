...
class VerificationsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """Creates a verification session for an account.

        If a verification is already in
        progress, existing session is returned unless `restart` is set. You can restart
        a verification by setting the `restart` attribute.
    ...
    def update(
        ...
        *,
        ...
        Use profile fields to update verification
    ...
    def list(
        ...
        *,
        ...
        page: int | Omit = omit,
        per: int | Omit = omit,
        profile_type: Literal["individual", "business"] | Omit = omit,
        status: Literal["not_started", "pending", "approved", "rejected"] | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        """List all verifications for a given account.

        Verifications can either be for a
        given user or business.

        Args:
          account_id: Filter verifications to a specific account.

          page: The page number to retrieve.

          per: The number of resources to return per page.

          profile_type: Filter by profile type.

          status: Filter by derived verification status.
