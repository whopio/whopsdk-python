...
from ..types import (
    ...
    identity_profile_attach_params,
    identity_profile_create_params,
    identity_profile_unlink_params,
...
from ..types.identity_profile_kind import IdentityProfileKind
from ..types.identity_profile_status import IdentityProfileStatus
from ..types.identity_profile_list_response import IdentityProfileListResponse
from ..types.identity_profile_create_response import IdentityProfileCreateResponse
...
class IdentityProfilesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        address_city: Optional[str] | Omit = omit,
        address_line1: Optional[str] | Omit = omit,
        address_postal_code: Optional[str] | Omit = omit,
        address_state: Optional[str] | Omit = omit,
        country: Optional[str] | Omit = omit,
        date_of_birth: Optional[str] | Omit = omit,
        first_name: Optional[str] | Omit = omit,
        last_name: Optional[str] | Omit = omit,
        phone: Optional[str] | Omit = omit,
        restart: Optional[bool] | Omit = omit,
        ...
        Args:
          kind: Which slot to verify: 'individual' (KYC) or 'business' (KYB).

          ledger_account_id: The ID of the LedgerAccount to verify (typically a company's primary ledger).

          address_city: Optional pre-fill claim — city.

          address_line1: Optional pre-fill claim — street address line 1.

          address_postal_code: Optional pre-fill claim — postal code.

          address_state: Optional pre-fill claim — state/region.

          country: Optional pre-fill claim (ISO2 or ISO3 country code).

          date_of_birth: Optional pre-fill claim (ISO date, e.g. 1990-05-15).

          first_name: Optional pre-fill claim.

          last_name: Optional pre-fill claim.

          phone: Optional pre-fill claim.

          restart: Force a fresh verification session, abandoning any session already in flight for
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                identity_profile_create_params.IdentityProfileCreateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=IdentityProfileCreateResponse,
        )
    ...
    def list(
        ...
        *,
        ...
        profile_type: Optional[IdentityProfileKind] | Omit = omit,
        status: Optional[IdentityProfileStatus] | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
    ...
    def attach(
        ...
        *,
        ...
        Args:
          ledger_account_id: The ID of the LedgerAccount to attach the identity profile to.
        ...
        if not identity_profile_id:
            raise ValueError(
                f"Expected a non-empty value for `identity_profile_id` but received {identity_profile_id!r}"
            )
        return self._post(
            path_template("/identity_profiles/{identity_profile_id}/attach", identity_profile_id=identity_profile_id),
            body=maybe_transform(
                {"ledger_account_id": ledger_account_id}, identity_profile_attach_params.IdentityProfileAttachParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return self._delete(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform(
                    {"ledger_account_id": ledger_account_id}, identity_profile_unlink_params.IdentityProfileUnlinkParams
                ),
            ),
            cast_to=IdentityProfile,
        )
