    ...
    def list(
        ...
        *,
        ...
        Args:
          ...
          ad_campaign_ids: Only return ads belonging to these ad campaigns (max 100). Combine with
              company_id.

          ad_group_id: Filter by ad group. Provide exactly one of ad_group_id, ad_campaign_id, or
              company_id.

          ad_group_ids: Only return ads belonging to these ad groups (max 100). Combine with company_id.
