...
from ..types import stat_raw_params, stat_sql_params, stat_metric_params, stat_describe_params
...
from ..types.stat_raw_response import StatRawResponse
from ..types.stat_sql_response import StatSqlResponse
from ..types.stat_metric_response import StatMetricResponse
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    stat_metric_params.StatMetricParams,
                ),
            ),
            cast_to=StatMetricResponse,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    stat_raw_params.StatRawParams,
                ),
            ),
            cast_to=StatRawResponse,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    stat_sql_params.StatSqlParams,
                ),
            ),
            cast_to=StatSqlResponse,
        )
...
class StatsResourceWithRawResponse:
    def __init__(self, stats: StatsResource) -> None:
        ...
        self.metric = to_raw_response_wrapper(
            stats.metric,
        )
...
class AsyncStatsResourceWithRawResponse:
    def __init__(self, stats: AsyncStatsResource) -> None:
        ...
        self.metric = async_to_raw_response_wrapper(
            stats.metric,
        )
...
class StatsResourceWithStreamingResponse:
    def __init__(self, stats: StatsResource) -> None:
        ...
        self.metric = to_streamed_response_wrapper(
            stats.metric,
        )
...
class AsyncStatsResourceWithStreamingResponse:
    def __init__(self, stats: AsyncStatsResource) -> None:
        ...
        self.metric = async_to_streamed_response_wrapper(
            stats.metric,
        )
