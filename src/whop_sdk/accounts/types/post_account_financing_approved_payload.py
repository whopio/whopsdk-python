...
class PostAccountFinancingApprovedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostAccountFinancingApprovedPayloadApiVersion = pydantic.Field()
    """
    ...
    type: PostAccountFinancingApprovedPayloadType = pydantic.Field()
    """
