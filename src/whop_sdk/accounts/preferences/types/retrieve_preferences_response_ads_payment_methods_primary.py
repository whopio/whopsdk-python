...
class RetrievePreferencesResponseAdsPaymentMethodsPrimary(UniversalBaseModel):
    ...
    type: RetrievePreferencesResponseAdsPaymentMethodsPrimaryType = pydantic.Field()
    """
