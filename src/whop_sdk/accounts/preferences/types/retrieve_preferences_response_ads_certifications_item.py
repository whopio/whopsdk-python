...
class RetrievePreferencesResponseAdsCertificationsItem(UniversalBaseModel):
    ...
    business_type: typing.Optional[RetrievePreferencesResponseAdsCertificationsItemBusinessType] = pydantic.Field(
        default=None
    )
    """
    ...
    certification_type: RetrievePreferencesResponseAdsCertificationsItemCertificationType = pydantic.Field()
    """
    ...
    status: RetrievePreferencesResponseAdsCertificationsItemStatus = pydantic.Field()
    """
