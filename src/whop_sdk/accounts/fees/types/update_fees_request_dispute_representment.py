...
from .update_fees_request_dispute_representment_regions_value import UpdateFeesRequestDisputeRepresentmentRegionsValue


class UpdateFeesRequestDisputeRepresentment(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestDisputeRepresentmentRegionsValue]] = pydantic.Field(
        default=None
    )
    """
