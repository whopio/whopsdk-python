...
class UpdateFeesRequestBankDeposit(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestBankDepositRegionsValue]] = pydantic.Field(default=None)
    """
