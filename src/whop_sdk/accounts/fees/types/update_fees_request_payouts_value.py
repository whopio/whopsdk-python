...
class UpdateFeesRequestPayoutsValue(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestPayoutsValueRegionsValue]] = pydantic.Field(default=None)
    """
