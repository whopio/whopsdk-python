...
class UpdateFeesRequestFraudScreening(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestFraudScreeningRegionsValue]] = pydantic.Field(
        default=None
    )
    """
