...
class UpdateFeesRequestBilling(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestBillingRegionsValue]] = pydantic.Field(default=None)
    """
