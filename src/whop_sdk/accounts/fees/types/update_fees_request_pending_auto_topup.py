...
class UpdateFeesRequestPendingAutoTopup(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestPendingAutoTopupRegionsValue]] = pydantic.Field(
        default=None
    )
    """
