...
class UpdateFeesRequestDisputeAlert(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestDisputeAlertRegionsValue]] = pydantic.Field(default=None)
    """
