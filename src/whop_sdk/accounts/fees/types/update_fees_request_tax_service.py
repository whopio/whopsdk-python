...
class UpdateFeesRequestTaxService(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestTaxServiceRegionsValue]] = pydantic.Field(default=None)
    """
