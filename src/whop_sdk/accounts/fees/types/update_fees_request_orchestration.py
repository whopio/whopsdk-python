...
class UpdateFeesRequestOrchestration(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestOrchestrationRegionsValue]] = pydantic.Field(
        default=None
    )
    """
