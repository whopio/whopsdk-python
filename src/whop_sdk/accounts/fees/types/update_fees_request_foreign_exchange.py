...
class UpdateFeesRequestForeignExchange(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestForeignExchangeRegionsValue]] = pydantic.Field(
        default=None
    )
    """
