...
class UpdateFeesRequestRevshare(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestRevshareRegionsValue]] = pydantic.Field(default=None)
    """
