...
class UpdateFeesRequestTransfers(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestTransfersRegionsValue]] = pydantic.Field(default=None)
    """
