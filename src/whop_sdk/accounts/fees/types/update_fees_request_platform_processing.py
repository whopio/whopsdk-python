...
class UpdateFeesRequestPlatformProcessing(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestPlatformProcessingRegionsValue]] = pydantic.Field(
        default=None
    )
    """
