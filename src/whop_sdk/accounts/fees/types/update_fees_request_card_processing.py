...
class UpdateFeesRequestCardProcessing(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestCardProcessingRegionsValue]] = pydantic.Field(
        default=None
    )
    """
