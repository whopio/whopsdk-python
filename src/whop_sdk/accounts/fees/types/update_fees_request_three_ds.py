...
class UpdateFeesRequestThreeDs(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestThreeDsRegionsValue]] = pydantic.Field(default=None)
    """
