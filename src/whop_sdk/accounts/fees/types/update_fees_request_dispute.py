...
class UpdateFeesRequestDispute(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestDisputeRegionsValue]] = pydantic.Field(default=None)
    """
