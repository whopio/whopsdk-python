...
from .update_fees_request_payment_methods_value_regions_value import UpdateFeesRequestPaymentMethodsValueRegionsValue


class UpdateFeesRequestPaymentMethodsValue(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestPaymentMethodsValueRegionsValue]] = pydantic.Field(
        default=None
    )
    """
