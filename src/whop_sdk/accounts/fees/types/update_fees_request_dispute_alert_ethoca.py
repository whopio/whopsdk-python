...
class UpdateFeesRequestDisputeAlertEthoca(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestDisputeAlertEthocaRegionsValue]] = pydantic.Field(
        default=None
    )
    """
