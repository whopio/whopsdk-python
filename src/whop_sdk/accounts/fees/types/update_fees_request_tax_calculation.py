...
class UpdateFeesRequestTaxCalculation(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestTaxCalculationRegionsValue]] = pydantic.Field(
        default=None
    )
    """
