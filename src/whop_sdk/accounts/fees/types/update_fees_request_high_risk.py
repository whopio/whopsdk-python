...
class UpdateFeesRequestHighRisk(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestHighRiskRegionsValue]] = pydantic.Field(default=None)
    """
