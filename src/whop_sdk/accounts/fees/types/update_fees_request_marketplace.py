...
class UpdateFeesRequestMarketplace(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestMarketplaceRegionsValue]] = pydantic.Field(default=None)
    """
