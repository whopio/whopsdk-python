...
class UpdateFeesRequestDisputeAlertCdrn(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestDisputeAlertCdrnRegionsValue]] = pydantic.Field(
        default=None
    )
    """
