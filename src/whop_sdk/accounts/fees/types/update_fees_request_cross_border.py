...
class UpdateFeesRequestCrossBorder(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestCrossBorderRegionsValue]] = pydantic.Field(default=None)
    """
