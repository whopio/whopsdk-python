...
class UpdateFeesRequestDisputeAlertRdr(UniversalBaseModel):
    """
    ...
    regions: typing.Optional[typing.Dict[str, UpdateFeesRequestDisputeAlertRdrRegionsValue]] = pydantic.Field(
        default=None
    )
    """
