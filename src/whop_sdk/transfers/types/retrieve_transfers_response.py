...
class RetrieveTransfersResponse(UniversalBaseModel):
    """
    ...
    created_by_user: typing.Optional[RetrieveTransfersResponseCreatedByUser] = pydantic.Field(default=None)
    """
    ...
    destination: RetrieveTransfersResponseDestination = pydantic.Field()
    """
    ...
    object: RetrieveTransfersResponseObject = pydantic.Field()
    """
    The object type. Discriminates the create response from a send or a claim link.
    """

    origin: RetrieveTransfersResponseOrigin = pydantic.Field()
    """
    ...
    status: RetrieveTransfersResponseStatus = pydantic.Field()
    """
