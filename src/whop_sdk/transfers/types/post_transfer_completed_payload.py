...
class PostTransferCompletedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostTransferCompletedPayloadApiVersion = pydantic.Field()
    """
    ...
    data: PostTransferCompletedPayloadData = pydantic.Field()
    """
    ...
    type: PostTransferCompletedPayloadType = pydantic.Field()
    """
