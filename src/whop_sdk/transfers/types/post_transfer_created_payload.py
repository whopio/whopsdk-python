...
class PostTransferCreatedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostTransferCreatedPayloadApiVersion = pydantic.Field()
    """
    ...
    data: PostTransferCreatedPayloadData = pydantic.Field()
    """
    ...
    type: PostTransferCreatedPayloadType = pydantic.Field()
    """
