...
class PostTransferCompletedPayloadData(UniversalBaseModel):
    """
    ...
    created_by_user: typing.Optional[PostTransferCompletedPayloadDataCreatedByUser] = pydantic.Field(default=None)
    """
    ...
    destination: PostTransferCompletedPayloadDataDestination = pydantic.Field()
    """
    ...
    object: PostTransferCompletedPayloadDataObject = pydantic.Field()
    """
    The object type. Discriminates the create response from a send or a claim link.
    """

    origin: PostTransferCompletedPayloadDataOrigin = pydantic.Field()
    """
    ...
    status: PostTransferCompletedPayloadDataStatus = pydantic.Field()
    """
