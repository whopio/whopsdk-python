...
from .post_membership_cancel_at_period_end_changed_payload_type import PostMembershipCancelAtPeriodEndChangedPayloadType


class PostMembershipCancelAtPeriodEndChangedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostMembershipCancelAtPeriodEndChangedPayloadApiVersion = pydantic.Field()
    """
    ...
    type: PostMembershipCancelAtPeriodEndChangedPayloadType = pydantic.Field()
    """
