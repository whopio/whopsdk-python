...
from .post_resolution_center_case_decided_payload_api_version import PostResolutionCenterCaseDecidedPayloadApiVersion
from .post_resolution_center_case_decided_payload_type import PostResolutionCenterCaseDecidedPayloadType


class PostResolutionCenterCaseDecidedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostResolutionCenterCaseDecidedPayloadApiVersion = pydantic.Field()
    """
    ...
    type: PostResolutionCenterCaseDecidedPayloadType = pydantic.Field()
    """
