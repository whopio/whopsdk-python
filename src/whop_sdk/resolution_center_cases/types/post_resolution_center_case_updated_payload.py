...
from .post_resolution_center_case_updated_payload_api_version import PostResolutionCenterCaseUpdatedPayloadApiVersion
from .post_resolution_center_case_updated_payload_type import PostResolutionCenterCaseUpdatedPayloadType


class PostResolutionCenterCaseUpdatedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostResolutionCenterCaseUpdatedPayloadApiVersion = pydantic.Field()
    """
    ...
    type: PostResolutionCenterCaseUpdatedPayloadType = pydantic.Field()
    """
