...
from .create_invoices_request_product_plan_custom_fields_item import CreateInvoicesRequestProductPlanCustomFieldsItem
...
class CreateInvoicesRequestProductPlan(UniversalBaseModel):
    """
    ...
    custom_fields: typing.Optional[typing.List[CreateInvoicesRequestProductPlanCustomFieldsItem]] = pydantic.Field(
        default=None
    )
    """
    ...
    payment_method_configuration: typing.Optional[CreateInvoicesRequestProductPlanPaymentMethodConfiguration] = (
