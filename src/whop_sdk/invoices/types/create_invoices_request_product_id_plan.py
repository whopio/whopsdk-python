...
class CreateInvoicesRequestProductIdPlan(UniversalBaseModel):
    """
    ...
    custom_fields: typing.Optional[typing.List[CreateInvoicesRequestProductIdPlanCustomFieldsItem]] = pydantic.Field(
        default=None
    )
    """
    ...
    payment_method_configuration: typing.Optional[CreateInvoicesRequestProductIdPlanPaymentMethodConfiguration] = (
