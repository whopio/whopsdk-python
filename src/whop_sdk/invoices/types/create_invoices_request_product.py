...
class CreateInvoicesRequestProduct(UniversalBaseModel):
    """
    ...
    billing_address: typing.Optional[CreateInvoicesRequestProductBillingAddress] = pydantic.Field(default=None)
    """
    ...
    plan: CreateInvoicesRequestProductPlan = pydantic.Field()
    """
    The plan attributes defining the price, currency, and billing interval for this invoice.
    """

    product: CreateInvoicesRequestProductProduct = pydantic.Field()
    """
