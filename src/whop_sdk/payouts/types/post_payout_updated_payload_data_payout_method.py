...
class PostPayoutUpdatedPayloadDataPayoutMethod(UniversalBaseModel):
    """
    ...
    supported_payout_method: typing.Optional[PostPayoutUpdatedPayloadDataPayoutMethodSupportedPayoutMethod] = (
