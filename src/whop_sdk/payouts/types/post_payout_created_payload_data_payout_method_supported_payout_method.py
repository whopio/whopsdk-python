...
class PostPayoutCreatedPayloadDataPayoutMethodSupportedPayoutMethod(UniversalBaseModel):
    """
    Supported payout method display details.
    """

    delivery_type: PostPayoutCreatedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType = pydantic.Field()
    """
