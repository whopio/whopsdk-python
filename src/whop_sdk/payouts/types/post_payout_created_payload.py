...
class PostPayoutCreatedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostPayoutCreatedPayloadApiVersion = pydantic.Field()
    """
    ...
    data: PostPayoutCreatedPayloadData
    ...
    type: PostPayoutCreatedPayloadType = pydantic.Field()
    """
