...
class PostPayoutReversedPayloadDataPayoutMethod(UniversalBaseModel):
    """
    ...
    supported_payout_method: typing.Optional[PostPayoutReversedPayloadDataPayoutMethodSupportedPayoutMethod] = (
