...
class PostWithdrawalUpdatedPayloadData(UniversalBaseModel):
    ...
    failure: typing.Optional[PostWithdrawalUpdatedPayloadDataFailure] = pydantic.Field(default=None)
    """
    ...
    fee_paid_by: PostWithdrawalUpdatedPayloadDataFeePaidBy = pydantic.Field()
    """
    ...
    object: PostWithdrawalUpdatedPayloadDataObject
    payer_name: typing.Optional[str] = pydantic.Field(default=None)
    """
    Name of the entity processing the payout.
    """

    payout_method: typing.Optional[PostWithdrawalUpdatedPayloadDataPayoutMethod] = pydantic.Field(default=None)
    """
    ...
    source: typing.Optional[PostWithdrawalUpdatedPayloadDataSource] = pydantic.Field(default=None)
    """
    ...
    speed: PostWithdrawalUpdatedPayloadDataSpeed = pydantic.Field()
    """
    Payout delivery speed.
    """

    status: PostWithdrawalUpdatedPayloadDataStatus = pydantic.Field()
    """
