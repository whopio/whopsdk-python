...
class PostPayoutUpdatedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostPayoutUpdatedPayloadApiVersion = pydantic.Field()
    """
    ...
    data: PostPayoutUpdatedPayloadData
    ...
    type: PostPayoutUpdatedPayloadType = pydantic.Field()
    """
