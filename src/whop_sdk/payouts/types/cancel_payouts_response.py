...
class CancelPayoutsResponse(UniversalBaseModel):
    ...
    failure: typing.Optional[CancelPayoutsResponseFailure] = pydantic.Field(default=None)
    """
    ...
    fee_paid_by: CancelPayoutsResponseFeePaidBy = pydantic.Field()
    """
    ...
    object: CancelPayoutsResponseObject
    payer_name: typing.Optional[str] = pydantic.Field(default=None)
    """
    Name of the entity processing the payout.
    """

    payout_method: typing.Optional[CancelPayoutsResponsePayoutMethod] = pydantic.Field(default=None)
    """
    ...
    source: typing.Optional[CancelPayoutsResponseSource] = pydantic.Field(default=None)
    """
    ...
    speed: CancelPayoutsResponseSpeed = pydantic.Field()
    """
    ...
    status: CancelPayoutsResponseStatus = pydantic.Field()
    """
