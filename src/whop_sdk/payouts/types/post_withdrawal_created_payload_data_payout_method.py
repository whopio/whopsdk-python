...
class PostWithdrawalCreatedPayloadDataPayoutMethod(UniversalBaseModel):
    """
    ...
    supported_payout_method: typing.Optional[PostWithdrawalCreatedPayloadDataPayoutMethodSupportedPayoutMethod] = (
