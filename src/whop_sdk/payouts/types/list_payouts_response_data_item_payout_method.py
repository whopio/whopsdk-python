...
class ListPayoutsResponseDataItemPayoutMethod(UniversalBaseModel):
    """
    ...
    supported_payout_method: typing.Optional[ListPayoutsResponseDataItemPayoutMethodSupportedPayoutMethod] = (
