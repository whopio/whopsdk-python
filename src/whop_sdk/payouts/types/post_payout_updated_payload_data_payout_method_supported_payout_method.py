...
class PostPayoutUpdatedPayloadDataPayoutMethodSupportedPayoutMethod(UniversalBaseModel):
    """
    Supported payout method display details.
    """

    delivery_type: PostPayoutUpdatedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType = pydantic.Field()
    """
