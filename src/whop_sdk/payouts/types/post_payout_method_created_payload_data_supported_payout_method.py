...
class PostPayoutMethodCreatedPayloadDataSupportedPayoutMethod(UniversalBaseModel):
    """
    ...
    delivery_type: PostPayoutMethodCreatedPayloadDataSupportedPayoutMethodDeliveryType = pydantic.Field()
    """
