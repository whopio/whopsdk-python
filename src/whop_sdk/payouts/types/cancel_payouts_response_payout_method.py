...
class CancelPayoutsResponsePayoutMethod(UniversalBaseModel):
    """
    ...
    supported_payout_method: typing.Optional[CancelPayoutsResponsePayoutMethodSupportedPayoutMethod] = pydantic.Field(
        default=None
    )
    """
