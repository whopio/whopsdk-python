...
class ListPayoutsResponseDataItem(UniversalBaseModel):
    ...
    failure: typing.Optional[ListPayoutsResponseDataItemFailure] = pydantic.Field(default=None)
    """
    ...
    fee_paid_by: ListPayoutsResponseDataItemFeePaidBy = pydantic.Field()
    """
    ...
    payout_method: typing.Optional[ListPayoutsResponseDataItemPayoutMethod] = pydantic.Field(default=None)
    """
    ...
    source: typing.Optional[ListPayoutsResponseDataItemSource] = pydantic.Field(default=None)
    """
    ...
    speed: ListPayoutsResponseDataItemSpeed = pydantic.Field()
    """
