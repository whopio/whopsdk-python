...
class PostPayoutReversedPayloadData(UniversalBaseModel):
    ...
    failure: typing.Optional[PostPayoutReversedPayloadDataFailure] = pydantic.Field(default=None)
    """
    ...
    fee_paid_by: PostPayoutReversedPayloadDataFeePaidBy = pydantic.Field()
    """
    ...
    object: PostPayoutReversedPayloadDataObject
    payer_name: typing.Optional[str] = pydantic.Field(default=None)
    """
    Name of the entity processing the payout.
    """

    payout_method: typing.Optional[PostPayoutReversedPayloadDataPayoutMethod] = pydantic.Field(default=None)
    """
    ...
    source: typing.Optional[PostPayoutReversedPayloadDataSource] = pydantic.Field(default=None)
    """
    ...
    speed: PostPayoutReversedPayloadDataSpeed = pydantic.Field()
    """
    ...
    status: PostPayoutReversedPayloadDataStatus = pydantic.Field()
    """
