...
class PostWithdrawalCreatedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostWithdrawalCreatedPayloadApiVersion = pydantic.Field()
    """
    ...
    data: PostWithdrawalCreatedPayloadData
    ...
    type: PostWithdrawalCreatedPayloadType = pydantic.Field()
    """
