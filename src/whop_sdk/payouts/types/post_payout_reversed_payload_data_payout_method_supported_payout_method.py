...
class PostPayoutReversedPayloadDataPayoutMethodSupportedPayoutMethod(UniversalBaseModel):
    """
    Supported payout method display details.
    """

    delivery_type: PostPayoutReversedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType = pydantic.Field()
    """
