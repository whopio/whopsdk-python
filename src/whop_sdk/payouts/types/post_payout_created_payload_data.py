...
class PostPayoutCreatedPayloadData(UniversalBaseModel):
    ...
    failure: typing.Optional[PostPayoutCreatedPayloadDataFailure] = pydantic.Field(default=None)
    """
    ...
    fee_paid_by: PostPayoutCreatedPayloadDataFeePaidBy = pydantic.Field()
    """
    ...
    object: PostPayoutCreatedPayloadDataObject
    payer_name: typing.Optional[str] = pydantic.Field(default=None)
    """
    Name of the entity processing the payout.
    """

    payout_method: typing.Optional[PostPayoutCreatedPayloadDataPayoutMethod] = pydantic.Field(default=None)
    """
    ...
    source: typing.Optional[PostPayoutCreatedPayloadDataSource] = pydantic.Field(default=None)
    """
    ...
    speed: PostPayoutCreatedPayloadDataSpeed = pydantic.Field()
    """
    ...
    status: PostPayoutCreatedPayloadDataStatus = pydantic.Field()
    """
