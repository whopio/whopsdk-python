...
class PostPayoutReversedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostPayoutReversedPayloadApiVersion = pydantic.Field()
    """
    ...
    data: PostPayoutReversedPayloadData
    ...
    type: PostPayoutReversedPayloadType = pydantic.Field()
    """
