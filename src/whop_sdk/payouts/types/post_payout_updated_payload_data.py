...
class PostPayoutUpdatedPayloadData(UniversalBaseModel):
    ...
    failure: typing.Optional[PostPayoutUpdatedPayloadDataFailure] = pydantic.Field(default=None)
    """
    ...
    fee_paid_by: PostPayoutUpdatedPayloadDataFeePaidBy = pydantic.Field()
    """
    ...
    object: PostPayoutUpdatedPayloadDataObject
    payer_name: typing.Optional[str] = pydantic.Field(default=None)
    """
    Name of the entity processing the payout.
    """

    payout_method: typing.Optional[PostPayoutUpdatedPayloadDataPayoutMethod] = pydantic.Field(default=None)
    """
    ...
    source: typing.Optional[PostPayoutUpdatedPayloadDataSource] = pydantic.Field(default=None)
    """
    ...
    speed: PostPayoutUpdatedPayloadDataSpeed = pydantic.Field()
    """
    ...
    status: PostPayoutUpdatedPayloadDataStatus = pydantic.Field()
    """
