...
class PostWithdrawalReversedPayloadDataPayoutMethod(UniversalBaseModel):
    """
    ...
    supported_payout_method: typing.Optional[PostWithdrawalReversedPayloadDataPayoutMethodSupportedPayoutMethod] = (
