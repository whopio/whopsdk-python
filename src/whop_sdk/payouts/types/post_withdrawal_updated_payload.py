...
class PostWithdrawalUpdatedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostWithdrawalUpdatedPayloadApiVersion = pydantic.Field()
    """
    ...
    data: PostWithdrawalUpdatedPayloadData
    ...
    type: PostWithdrawalUpdatedPayloadType = pydantic.Field()
    """
