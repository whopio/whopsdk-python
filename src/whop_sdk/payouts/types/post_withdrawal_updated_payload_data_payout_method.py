...
class PostWithdrawalUpdatedPayloadDataPayoutMethod(UniversalBaseModel):
    """
    ...
    supported_payout_method: typing.Optional[PostWithdrawalUpdatedPayloadDataPayoutMethodSupportedPayoutMethod] = (
