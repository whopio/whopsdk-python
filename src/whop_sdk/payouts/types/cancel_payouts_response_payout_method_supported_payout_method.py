...
class CancelPayoutsResponsePayoutMethodSupportedPayoutMethod(UniversalBaseModel):
    """
    Supported payout method display details.
    """

    delivery_type: CancelPayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType = pydantic.Field()
    """
