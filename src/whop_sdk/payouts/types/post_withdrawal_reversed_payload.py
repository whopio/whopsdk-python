...
class PostWithdrawalReversedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostWithdrawalReversedPayloadApiVersion = pydantic.Field()
    """
    ...
    data: PostWithdrawalReversedPayloadData
    ...
    type: PostWithdrawalReversedPayloadType = pydantic.Field()
    """
