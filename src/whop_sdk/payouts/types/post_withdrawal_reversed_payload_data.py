...
class PostWithdrawalReversedPayloadData(UniversalBaseModel):
    ...
    failure: typing.Optional[PostWithdrawalReversedPayloadDataFailure] = pydantic.Field(default=None)
    """
    ...
    fee_paid_by: PostWithdrawalReversedPayloadDataFeePaidBy = pydantic.Field()
    """
    ...
    object: PostWithdrawalReversedPayloadDataObject
    payer_name: typing.Optional[str] = pydantic.Field(default=None)
    """
    Name of the entity processing the payout.
    """

    payout_method: typing.Optional[PostWithdrawalReversedPayloadDataPayoutMethod] = pydantic.Field(default=None)
    """
    ...
    source: typing.Optional[PostWithdrawalReversedPayloadDataSource] = pydantic.Field(default=None)
    """
    ...
    speed: PostWithdrawalReversedPayloadDataSpeed = pydantic.Field()
    """
    Payout delivery speed.
    """

    status: PostWithdrawalReversedPayloadDataStatus = pydantic.Field()
    """
