...
class PostPayoutMethodCreatedPayload(UniversalBaseModel):
    account_id: typing.Optional[str] = pydantic.Field(default=None)
    """
    The account ID that this webhook event is associated with
    """

    api_version: PostPayoutMethodCreatedPayloadApiVersion = pydantic.Field()
    """
    ...
    data: PostPayoutMethodCreatedPayloadData
    ...
    type: PostPayoutMethodCreatedPayloadType = pydantic.Field()
    """
