...
class UpdateMethodsResponseSupportedPayoutMethod(UniversalBaseModel):
    country_code: typing.Optional[str] = pydantic.Field(default=None)
    """
    ISO 3166-1 alpha-3 country the destination pays out to.
    """

    delivery_type: UpdateMethodsResponseSupportedPayoutMethodDeliveryType = pydantic.Field()
    """
