        ...
        try:
            if 200 <= _response.status_code < 300:
                _parsed_response = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ListCourseChaptersResponse,  # type: ignore
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    CourseChapter,
                    parse_obj_as(
                        type_=CourseChapter,  # type: ignore
                        object_=_response.json(),
                    ),
                )
...
class AsyncRawCourseChaptersClient:
    ...
    async def create(
        ...
        *,
        ...
        title: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CourseChapter]:
        """
        Create a new chapter within a course to organize lessons into sections.
