...
from whop_sdk.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    _should_retry,
...
from whop_sdk.core.request_options import RequestOptions
...
@patch("whop_sdk.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("whop_sdk.core.http_client.asyncio.sleep", new_callable=AsyncMock)
