...
class TestCards:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_pin(self, client: Whop) -> None:
        card = client.cards.pin(
            "id",
        )
        assert_matches_type(CardPin, card, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_pin(self, client: Whop) -> None:
        response = client.cards.with_raw_response.pin(
            "id",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_pin(self, client: Whop) -> None:
        with client.cards.with_streaming_response.pin(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_pin(self, client: Whop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.cards.with_raw_response.pin(
                "",
            )

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_secrets(self, client: Whop) -> None:
        card = client.cards.secrets(
            "id",
        )
        assert_matches_type(CardSecrets, card, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_secrets(self, client: Whop) -> None:
        response = client.cards.with_raw_response.secrets(
            "id",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_secrets(self, client: Whop) -> None:
        with client.cards.with_streaming_response.secrets(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_secrets(self, client: Whop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.cards.with_raw_response.secrets(
                "",
            )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_update_pin(self, client: Whop) -> None:
        card = client.cards.update_pin(
            id="id",
            pin="pin",
        )
        assert_matches_type(CardUpdatePinResponse, card, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_update_pin(self, client: Whop) -> None:
        response = client.cards.with_raw_response.update_pin(
            id="id",
            pin="pin",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_update_pin(self, client: Whop) -> None:
        with client.cards.with_streaming_response.update_pin(
            id="id",
            pin="pin",
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_update_pin(self, client: Whop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.cards.with_raw_response.update_pin(
                id="",
                pin="pin",
            )
...
class TestAsyncCards:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_pin(self, async_client: AsyncWhop) -> None:
        card = await async_client.cards.pin(
            "id",
        )
        assert_matches_type(CardPin, card, path=["response"])
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_pin(self, async_client: AsyncWhop) -> None:
        response = await async_client.cards.with_raw_response.pin(
            "id",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_pin(self, async_client: AsyncWhop) -> None:
        async with async_client.cards.with_streaming_response.pin(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_pin(self, async_client: AsyncWhop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.cards.with_raw_response.pin(
                "",
            )

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_secrets(self, async_client: AsyncWhop) -> None:
        card = await async_client.cards.secrets(
            "id",
        )
        assert_matches_type(CardSecrets, card, path=["response"])
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_secrets(self, async_client: AsyncWhop) -> None:
        response = await async_client.cards.with_raw_response.secrets(
            "id",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_secrets(self, async_client: AsyncWhop) -> None:
        async with async_client.cards.with_streaming_response.secrets(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_secrets(self, async_client: AsyncWhop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.cards.with_raw_response.secrets(
                "",
            )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_update_pin(self, async_client: AsyncWhop) -> None:
        card = await async_client.cards.update_pin(
            id="id",
            pin="pin",
        )
        assert_matches_type(CardUpdatePinResponse, card, path=["response"])
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_update_pin(self, async_client: AsyncWhop) -> None:
        response = await async_client.cards.with_raw_response.update_pin(
            id="id",
            pin="pin",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_update_pin(self, async_client: AsyncWhop) -> None:
        async with async_client.cards.with_streaming_response.update_pin(
            id="id",
            pin="pin",
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_update_pin(self, async_client: AsyncWhop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.cards.with_raw_response.update_pin(
                id="",
                pin="pin",
            )
