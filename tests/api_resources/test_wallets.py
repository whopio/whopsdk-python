...
class TestWallets:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_supported_assets(self, client: Whop) -> None:
        wallet = client.wallets.supported_assets()
        assert_matches_type(WalletSupportedAssetsResponse, wallet, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_supported_assets(self, client: Whop) -> None:
        response = client.wallets.with_raw_response.supported_assets()
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_supported_assets(self, client: Whop) -> None:
        with client.wallets.with_streaming_response.supported_assets() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncWallets:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_supported_assets(self, async_client: AsyncWhop) -> None:
        wallet = await async_client.wallets.supported_assets()
        assert_matches_type(WalletSupportedAssetsResponse, wallet, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_supported_assets(self, async_client: AsyncWhop) -> None:
        response = await async_client.wallets.with_raw_response.supported_assets()
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_supported_assets(self, async_client: AsyncWhop) -> None:
        async with async_client.wallets.with_streaming_response.supported_assets() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
