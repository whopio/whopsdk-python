...
class TestWallets:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_sign_message(self, client: Whop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.wallets.with_raw_response.sign_message(
                account_id="",
                chain_id=0,
                message={},
                type="personal_sign",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_sign_transaction(self, client: Whop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            client.wallets.with_raw_response.sign_transaction(
                account_id="",
                chain_id=0,
                to="to",
            )
...
class TestAsyncWallets:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_sign_message(self, async_client: AsyncWhop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.wallets.with_raw_response.sign_message(
                account_id="",
                chain_id=0,
                message={},
                type="personal_sign",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_sign_transaction(self, async_client: AsyncWhop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_id` but received ''"):
            await async_client.wallets.with_raw_response.sign_transaction(
                account_id="",
                chain_id=0,
                to="to",
            )
