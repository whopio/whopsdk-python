...
from whop_sdk.types import DisputeAlert
...
class TestDisputeAlerts:
    ...
    def test_method_retrieve(self, client: Whop) -> None:
        ...
        assert_matches_type(DisputeAlert, dispute_alert, path=["response"])
    ...
    def test_method_list(self, client: Whop) -> None:
        ...
        assert_matches_type(SyncCursorPage[DisputeAlert], dispute_alert, path=["response"])
...
class TestAsyncDisputeAlerts:
    ...
    async def test_method_list(self, async_client: AsyncWhop) -> None:
        ...
        assert_matches_type(AsyncCursorPage[DisputeAlert], dispute_alert, path=["response"])
