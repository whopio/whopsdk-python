...
class TestCardTransactions:
    ...
    def test_method_list(self, client: Whop) -> None:
        ...
        assert_matches_type(SyncCursorPage[CardTransactionListResponse], card_transaction, path=["response"])
    ...
    def test_streaming_response_list(self, client: Whop) -> None:
        with client.card_transactions.with_streaming_response.list(
            company_id="biz_xxxxxxxxxxxxxx",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncCardTransactions:
    ...
    async def test_method_list(self, async_client: AsyncWhop) -> None:
        ...
        assert_matches_type(AsyncCursorPage[CardTransactionListResponse], card_transaction, path=["response"])
    ...
    async def test_streaming_response_list(self, async_client: AsyncWhop) -> None:
        async with async_client.card_transactions.with_streaming_response.list(
            company_id="biz_xxxxxxxxxxxxxx",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
