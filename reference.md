...
**merchant_category_code:** `typing.Optional[str]` — Four-digit MCC, including leading zeros. Must match together with merchant_name.
...
**merchant_name:** `typing.Optional[str]` — Raw merchant name reported by the card provider. Must contain a non-whitespace character. Matched with the MCC; not a substring or wildcard.
