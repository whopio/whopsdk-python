...
- <code title="post /calculate-tax">client.calculate_tax.<a href="./src/whop_sdk/resources/calculate_tax.py">create</a>(\*\*<a href="src/whop_sdk/types/calculate_tax_create_params.py">params</a>) -> <a href="./src/whop_sdk/types/calculate_tax_create_response.py">CalculateTaxCreateResponse</a></code>
