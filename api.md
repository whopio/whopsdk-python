...
- <code title="get /stats/schema">client.stats.<a href="./src/whop_sdk/resources/stats.py">schema</a>(\*\*<a href="src/whop_sdk/types/stat_schema_params.py">params</a>) -> <a href="./src/whop_sdk/types/stat_schema_response.py">StatSchemaResponse</a></code>
- <code title="get /stats/time_series">client.stats.<a href="./src/whop_sdk/resources/stats.py">time_series</a>(\*\*<a href="src/whop_sdk/types/stat_time_series_params.py">params</a>) -> <a href="./src/whop_sdk/types/stat_time_series_response.py">StatTimeSeriesResponse</a></code>
