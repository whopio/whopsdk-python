...
```python
from whop_sdk.types import Account, AccountListResponse
```
...
- <code title="get /wallets/ping">client.wallets.<a href="./src/whop_sdk/resources/wallets.py">ping</a>() -> <a href="./src/whop_sdk/types/wallet_ping_response.py">WalletPingResponse</a></code>
