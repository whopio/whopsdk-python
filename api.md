...
- <code title="post /wallets/withdrawals">client.wallets.<a href="./src/whop_sdk/resources/wallets.py">create_withdrawal</a>(\*\*<a href="src/whop_sdk/types/wallet_create_withdrawal_params.py">params</a>) -> <a href="./src/whop_sdk/types/wallet_create_withdrawal_response.py">WalletCreateWithdrawalResponse</a></code>
