...
- <code title="post /apps/{id}/deploy">client.apps.<a href="./src/whop_sdk/resources/apps.py">deploy</a>(id, \*\*<a href="src/whop_sdk/types/app_deploy_params.py">params</a>) -> <a href="./src/whop_sdk/types/app_deploy_response.py">AppDeployResponse</a></code>
...
```python
from whop_sdk.types import CancelOptions, MembershipInviteResponse, MembershipTransferResponse
```
...
- <code title="post /memberships/{id}/transfer">client.memberships.<a href="./src/whop_sdk/resources/memberships.py">transfer</a>(id) -> <a href="./src/whop_sdk/types/membership_transfer_response.py">MembershipTransferResponse</a></code>
...
- <code title="post /payments">client.payments.<a href="./src/whop_sdk/resources/payments.py">create</a>(\*\*<a href="src/whop_sdk/types/payment_create_params.py">params</a>) -> <a href="./src/whop_sdk/types/payment_create_response.py">PaymentCreateResponse</a></code>
- <code title="get /payments/{id}">client.payments.<a href="./src/whop_sdk/resources/payments.py">retrieve</a>(id) -> <a href="./src/whop_sdk/types/payment_retrieve_response.py">PaymentRetrieveResponse</a></code>
...
- <code title="get /bounty_submissions/{id}">client.bounty_submissions.<a href="./src/whop_sdk/resources/bounty_submissions.py">retrieve</a>(id, \*\*<a href="src/whop_sdk/types/bounty_submission_retrieve_params.py">params</a>) -> <a href="./src/whop_sdk/types/bounty_submission.py">BountySubmission</a></code>
