...
- <code title="get /wallets/{account_id}/deposit-address">client.wallets.<a href="./src/whop_sdk/resources/wallets.py">deposit_address</a>(account_id) -> <a href="./src/whop_sdk/types/wallet_deposit_address_response.py">WalletDepositAddressResponse</a></code>
