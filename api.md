...
- <code title="post /wallets/{account_id}/sign-message">client.wallets.<a href="./src/whop_sdk/resources/wallets.py">sign_message</a>(account_id, \*\*<a href="src/whop_sdk/types/wallet_sign_message_params.py">params</a>) -> <a href="./src/whop_sdk/types/wallet_sign_message_response.py">WalletSignMessageResponse</a></code>
- <code title="post /wallets/{account_id}/sign-transaction">client.wallets.<a href="./src/whop_sdk/resources/wallets.py">sign_transaction</a>(account_id, \*\*<a href="src/whop_sdk/types/wallet_sign_transaction_params.py">params</a>) -> <a href="./src/whop_sdk/types/wallet_sign_transaction_response.py">WalletSignTransactionResponse</a></code>
