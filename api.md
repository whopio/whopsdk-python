...
```python
from whop_sdk.types import Dispute, DisputeStatuses
```
...
```python
from whop_sdk.types import SetupIntent, SetupIntentStatus
```
...
- <code title="get /setup_intents">client.setup_intents.<a href="./src/whop_sdk/resources/setup_intents.py">list</a>(\*\*<a href="src/whop_sdk/types/setup_intent_list_params.py">params</a>) -> <a href="./src/whop_sdk/types/setup_intent.py">SyncCursorPage[SetupIntent]</a></code>
